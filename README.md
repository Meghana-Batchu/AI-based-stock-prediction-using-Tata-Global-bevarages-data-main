●Developed an AI-based stock price prediction system using Python, Django, and Decision Tree Regression to analyze historical data and predict market trends with improved accuracy.
